                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="unidades" value="mililitros" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="vent">Armário Ventilado</label>
                                        <input type="text" class="form-control" id="vent" value="Não Necessita" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="condicoes">Condições de Armazenamento</label>
                                        <input type="text" class="form-control" id="condicoes" value="Não Necessita" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="stock-box">
